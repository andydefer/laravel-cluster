...
final class FunctionNodeSqliteTest extends SqliteTestCase
{
    ...
    public function test_sqlite_to_sql_count(): void
    {
        $node = new FunctionNode('COUNT', 'addresses', ComparisonOperator::GREATER_THAN, '2');
    ...
    public function test_sqlite_to_sql_sum(): void
    {
        $node = new FunctionNode('SUM', 'prices', ComparisonOperator::GREATER_THAN, '500');
    ...
    public function test_sqlite_to_sql_avg(): void
    {
        $node = new FunctionNode('AVG', 'scores', ComparisonOperator::GREATER_THAN_OR_EQUAL, '85');
    ...
    public function test_sqlite_to_sql_min(): void
    {
        $node = new FunctionNode('MIN', 'scores', ComparisonOperator::LESS_THAN, '75');
    ...
    public function test_sqlite_to_sql_max(): void
    {
        $node = new FunctionNode('MAX', 'scores', ComparisonOperator::GREATER_THAN, '95');
    ...
    public function test_sqlite_to_sql_length(): void
    {
        $node = new FunctionNode('LENGTH', 'name', ComparisonOperator::GREATER_THAN, '5');
    ...
    public function test_sqlite_to_sql_count_equals(): void
    {
        $node = new FunctionNode('COUNT', 'addresses', ComparisonOperator::EQUAL, '2');
    ...
    public function test_sqlite_to_sql_count_not_equal(): void
    {
    ...
    public function test_sqlite_to_sql_with_nested_path(): void
    {
        $node = new FunctionNode('COUNT', 'settings.notifications', ComparisonOperator::GREATER_THAN, '1');
    ...
    public function test_sqlite_to_sql_with_null_value(): void
    {
        $node = new FunctionNode('COUNT', 'addresses', ComparisonOperator::EQUAL, null);
    ...
    public function test_sqlite_to_sql_unknown_function(): void
    {
        $node = new FunctionNode('UNKNOWN', 'addresses', ComparisonOperator::GREATER_THAN, '0');
    ...
    public function test_sqlite_to_eloquent_count(): void
    {
        $node = new FunctionNode('COUNT', 'addresses', ComparisonOperator::GREATER_THAN, '2');
    ...
    public function test_sqlite_to_eloquent_sum(): void
    {
        $node = new FunctionNode('SUM', 'prices', ComparisonOperator::GREATER_THAN, '500');
    ...
    public function test_sqlite_to_eloquent_avg(): void
    {
        $node = new FunctionNode('AVG', 'scores', ComparisonOperator::GREATER_THAN_OR_EQUAL, '85');
    ...
    public function test_sqlite_to_eloquent_min(): void
    {
        $node = new FunctionNode('MIN', 'scores', ComparisonOperator::LESS_THAN, '75');
    ...
    public function test_sqlite_to_eloquent_max(): void
    {
        $node = new FunctionNode('MAX', 'scores', ComparisonOperator::GREATER_THAN, '95');
    ...
    public function test_sqlite_to_eloquent_length(): void
    {
        $node = new FunctionNode('LENGTH', 'name', ComparisonOperator::GREATER_THAN, '5');
    ...
    public function test_sqlite_to_eloquent_count_equals(): void
    {
        $node = new FunctionNode('COUNT', 'addresses', ComparisonOperator::EQUAL, '2');
    ...
    public function test_sqlite_to_eloquent_combined_with_condition(): void
    {
    ...
    public function test_sqlite_to_eloquent_with_group_node(): void
    {
    ...
    public function test_sqlite_get_children_returns_empty_array(): void
    {
        $node = new FunctionNode('COUNT', 'addresses', ComparisonOperator::GREATER_THAN, '2');
