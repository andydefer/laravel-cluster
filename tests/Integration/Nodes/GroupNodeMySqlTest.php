...
final class GroupNodeMySqlTest extends MySqlTestCase
{
    ...
    public function test_mysql_to_sql_and(): void
    {
        $node1 = new ConditionNode('status', ComparisonOperator::EQUAL, 'active');
        $node2 = new ConditionNode('role', ComparisonOperator::EQUAL, 'admin');
        ...
        $expected = "(JSON_UNQUOTE(JSON_EXTRACT(clusters, '$.\"status\"')) = 'active' AND JSON_UNQUOTE(JSON_EXTRACT(clusters, '$.\"role\"')) = 'admin')";
        $this->assertEquals($expected, $sql);
    }

    public function test_mysql_to_sql_or(): void
    {
        $node1 = new ConditionNode('status', ComparisonOperator::EQUAL, 'active');
        $node2 = new ConditionNode('role', ComparisonOperator::EQUAL, 'admin');
        ...
        $expected = "(JSON_UNQUOTE(JSON_EXTRACT(clusters, '$.\"status\"')) = 'active' OR JSON_UNQUOTE(JSON_EXTRACT(clusters, '$.\"role\"')) = 'admin')";
        $this->assertEquals($expected, $sql);
    }

    public function test_mysql_to_sql_multiple_children(): void
    {
        $node1 = new ConditionNode('status', ComparisonOperator::EQUAL, 'active');
        $node2 = new ConditionNode('role', ComparisonOperator::EQUAL, 'admin');
        $node3 = new ConditionNode('verified', ComparisonOperator::EQUAL, 'yes');
        ...
        $expected = "(JSON_UNQUOTE(JSON_EXTRACT(clusters, '$.\"status\"')) = 'active' AND JSON_UNQUOTE(JSON_EXTRACT(clusters, '$.\"role\"')) = 'admin' AND JSON_UNQUOTE(JSON_EXTRACT(clusters, '$.\"verified\"')) = 'yes')";
        $this->assertEquals($expected, $sql);
    }

    public function test_mysql_to_sql_single_child(): void
    {
    ...
    public function test_mysql_to_sql_nested_groups(): void
    {
        $node1 = new ConditionNode('status', ComparisonOperator::EQUAL, 'active');
        $node2 = new ConditionNode('role', ComparisonOperator::EQUAL, 'admin');
        ...
        $expected = "((JSON_UNQUOTE(JSON_EXTRACT(clusters, '$.\"status\"')) = 'active' OR JSON_UNQUOTE(JSON_EXTRACT(clusters, '$.\"role\"')) = 'admin') AND JSON_UNQUOTE(JSON_EXTRACT(clusters, '$.\"verified\"')) = 'yes')";
        $this->assertEquals($expected, $sql);
    }

    public function test_mysql_to_sql_postgres(): void
    {
        $node1 = new ConditionNode('status', ComparisonOperator::EQUAL, 'active');
        $node2 = new ConditionNode('role', ComparisonOperator::EQUAL, 'admin');
    ...
    public function test_mysql_to_eloquent_and(): void
    {
        $node1 = new ConditionNode('status', ComparisonOperator::EQUAL, 'active');
        $node2 = new ConditionNode('role', ComparisonOperator::EQUAL, 'admin');
    ...
    public function test_mysql_to_eloquent_or(): void
    {
        $node1 = new ConditionNode('status', ComparisonOperator::EQUAL, 'active');
        $node2 = new ConditionNode('role', ComparisonOperator::EQUAL, 'admin');
    ...
    public function test_mysql_to_eloquent_multiple_children(): void
    {
        $node1 = new ConditionNode('status', ComparisonOperator::EQUAL, 'active');
        $node2 = new ConditionNode('role', ComparisonOperator::EQUAL, 'admin');
        $node3 = new ConditionNode('verified', ComparisonOperator::EQUAL, 'yes');
    ...
    public function test_mysql_to_eloquent_nested_groups(): void
    {
        $node1 = new ConditionNode('status', ComparisonOperator::EQUAL, 'active');
        $node2 = new ConditionNode('role', ComparisonOperator::EQUAL, 'admin');
    ...
    public function test_mysql_to_eloquent_with_or_where_nested(): void
    {
        $node1 = new ConditionNode('status', ComparisonOperator::EQUAL, 'active');
    ...
    public function test_mysql_get_children_empty(): void
    {
        $group = new GroupNode(LogicalOperator::AND);
