...
final class ConditionNodeSqliteTest extends SqliteTestCase
{
    ...
    public function test_sqlite_to_sql_equals(): void
    {
    ...
    public function test_sqlite_to_sql_not_equal(): void
    {
    ...
    public function test_sqlite_to_sql_greater_than(): void
    {
    ...
    public function test_sqlite_to_sql_greater_than_or_equal(): void
    {
        $node = new ConditionNode('age', ComparisonOperator::GREATER_THAN_OR_EQUAL, '30');
        $sql = $node->toSql('clusters', DatabaseDriver::SQLITE);

        $expected = "CAST(json_extract(clusters, '$.age') AS INTEGER) >= 30";
        $this->assertEquals($expected, $sql);
    }

    public function test_sqlite_to_sql_less_than(): void
    {
    ...
    public function test_sqlite_to_sql_less_than_or_equal(): void
    {
    ...
    public function test_sqlite_to_sql_boolean_yes(): void
    {
        $node = new ConditionNode('lang_fr', ComparisonOperator::EQUAL, 'yes');
        $sql = $node->toSql('clusters', DatabaseDriver::SQLITE);

        $expected = "json_extract(clusters, '$.lang_fr') = 'yes'";
        $this->assertEquals($expected, $sql);
    }

    public function test_sqlite_to_sql_boolean_no(): void
    {
        $node = new ConditionNode('lang_en', ComparisonOperator::EQUAL, 'no');
        $sql = $node->toSql('clusters', DatabaseDriver::SQLITE);

        $expected = "json_extract(clusters, '$.lang_en') = 'no'";
        $this->assertEquals($expected, $sql);
    }

    public function test_sqlite_to_sql_exists(): void
    {
    ...
    public function test_sqlite_to_sql_not_exists(): void
    {
    ...
    public function test_sqlite_to_sql_like(): void
    {
    ...
    public function test_sqlite_to_sql_like_pattern_starts(): void
    {
        $node = new ConditionNode('name', ComparisonOperator::LIKE, 'john%');
        $sql = $node->toSql('clusters', DatabaseDriver::SQLITE);
    ...
    public function test_sqlite_to_sql_like_pattern_ends(): void
    {
    ...
    public function test_sqlite_to_sql_not_like(): void
    {
    ...
    public function test_sqlite_to_sql_like_multiple_patterns(): void
    {
        $node = new ConditionNode('name', ComparisonOperator::LIKE, '%j%h%n');
        $sql = $node->toSql('clusters', DatabaseDriver::SQLITE);

        $expected = "LOWER(json_extract(clusters, '$.name')) LIKE LOWER('%j%h%n')";
        $this->assertEquals($expected, $sql);
    }
    ...
    public function test_sqlite_to_eloquent_equals(): void
    {
        $node = new ConditionNode('status', ComparisonOperator::EQUAL, 'active');
    ...
    public function test_sqlite_to_eloquent_not_equal(): void
    {
        $node = new ConditionNode('status', ComparisonOperator::NOT_EQUAL, 'inactive');
        $query = TestCluster::query();
    ...
    public function test_sqlite_to_eloquent_greater_than(): void
    {
        $node = new ConditionNode('age', ComparisonOperator::GREATER_THAN, '25');
        $query = TestCluster::query();
    ...
    public function test_sqlite_to_eloquent_greater_than_or_equal(): void
    {
        $node = new ConditionNode('age', ComparisonOperator::GREATER_THAN_OR_EQUAL, '30');
        $query = TestCluster::query();
    ...
    public function test_sqlite_to_eloquent_less_than(): void
    {
        $node = new ConditionNode('age', ComparisonOperator::LESS_THAN, '30');
        $query = TestCluster::query();
    ...
    public function test_sqlite_to_eloquent_less_than_or_equal(): void
    {
        $node = new ConditionNode('age', ComparisonOperator::LESS_THAN_OR_EQUAL, '25');
        $query = TestCluster::query();
    ...
    public function test_sqlite_to_eloquent_boolean_yes(): void
    {
        $node = new ConditionNode('lang_fr', ComparisonOperator::EQUAL, 'yes');
        $query = TestCluster::query();
    ...
    public function test_sqlite_to_eloquent_boolean_no(): void
    {
        $node = new ConditionNode('lang_en', ComparisonOperator::EQUAL, 'no');
        $query = TestCluster::query();
    ...
    public function test_sqlite_to_eloquent_exists(): void
    {
        $node = new ConditionNode('lang_fr', ComparisonOperator::EXISTS);
        $query = TestCluster::query();
    ...
    public function test_sqlite_to_eloquent_not_exists(): void
    {
        $node = new ConditionNode('lang_es', ComparisonOperator::NOT_EXISTS);
        $query = TestCluster::query();
        ...
        $sql = $query->toSql();
        $this->assertStringContainsString("json_extract(clusters, '$.lang_es')", $sql);
    ...
    public function test_sqlite_to_eloquent_like(): void
    {
        $node = new ConditionNode('name', ComparisonOperator::LIKE, 'john%');
        $query = TestCluster::query();
    ...
    public function test_sqlite_to_eloquent_not_like(): void
    {
        $node = new ConditionNode('name', ComparisonOperator::NOT_LIKE, 'john%');
        $query = TestCluster::query();
    ...
    public function test_sqlite_to_eloquent_like_contains_multiple_patterns(): void
    {
        $node = new ConditionNode('name', ComparisonOperator::LIKE, '%j%h%n');
        $query = TestCluster::query();
    ...
    public function test_sqlite_to_eloquent_like_multiple_patterns_strict(): void
    {
    ...
    public function test_sqlite_to_eloquent_multiple_conditions(): void
    {
        ...
        $query = TestCluster::query();
        $node1->toEloquent($query, 'clusters', DatabaseDriver::SQLITE);
    ...
    public function test_sqlite_to_eloquent_with_or_condition(): void
    {
        $query = TestCluster::query();
        ...
        $query->where(function (Builder $q) {
            ...
            $node1->toEloquent($q, 'clusters', DatabaseDriver::SQLITE);
            $q->orWhere(function (Builder $sub) use ($node2) {
                $node2->toEloquent($sub, 'clusters', DatabaseDriver::SQLITE);
            });
        });
    ...
    public function test_sqlite_to_eloquent_with_numeric_comparison(): void
    {
    ...
    public function test_sqlite_to_eloquent_with_null_value(): void
    {
    ...
    public function test_sqlite_get_json_path(): void
    {
