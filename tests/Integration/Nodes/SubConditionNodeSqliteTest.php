...
final class SubConditionNodeSqliteTest extends SqliteTestCase
{
    ...
    public function test_sqlite_to_sql_subcondition_simple(): void
    {
        $condition = new ConditionNode('city', ComparisonOperator::EQUAL, 'kinshasa');
        $node = new SubConditionNode('addresses', $condition);
    ...
    public function test_sqlite_to_sql_subcondition_with_and(): void
    {
        $cityCondition = new ConditionNode('city', ComparisonOperator::EQUAL, 'kinshasa');
        $countryCondition = new ConditionNode('country', ComparisonOperator::EQUAL, 'rdc');
        $andNode = new GroupNode(LogicalOperator::AND, $cityCondition, $countryCondition);
    ...
    public function test_sqlite_to_sql_subcondition_with_or(): void
    {
        $condition1 = new ConditionNode('city', ComparisonOperator::EQUAL, 'kinshasa');
        $condition2 = new ConditionNode('city', ComparisonOperator::EQUAL, 'paris');
        $orNode = new GroupNode(LogicalOperator::OR, $condition1, $condition2);
    ...
    public function test_sqlite_to_sql_subcondition_with_like(): void
    {
        $condition = new ConditionNode('city', ComparisonOperator::LIKE, 'kin%');
        $node = new SubConditionNode('addresses', $condition);
    ...
    public function test_sqlite_to_sql_subcondition_with_not_like(): void
    {
    ...
    public function test_sqlite_to_sql_subcondition_with_exists(): void
    {
    ...
    public function test_sqlite_to_sql_subcondition_with_not_exists(): void
    {
    ...
    public function test_sqlite_to_sql_subcondition_with_nested_path(): void
    {
        $condition = new ConditionNode('email', ComparisonOperator::EQUAL, 'yes');
        $node = new SubConditionNode('settings.notifications', $condition);
        ...
        $expected = "EXISTS (SELECT 1 FROM json_each(clusters, '$.settings.notifications') WHERE json_extract(value, '$.email') = 'yes')";
        $this->assertEquals($expected, $sql);
    }
    ...
    public function test_sqlite_to_eloquent_subcondition_simple(): void
    {
        $condition = new ConditionNode('city', ComparisonOperator::EQUAL, 'Kinshasa');
        $node = new SubConditionNode('addresses', $condition);
    ...
    public function test_sqlite_to_eloquent_subcondition_with_and(): void
    {
        $cityCondition = new ConditionNode('city', ComparisonOperator::EQUAL, 'Kinshasa');
        $countryCondition = new ConditionNode('country', ComparisonOperator::EQUAL, 'RDC');
        $andNode = new GroupNode(LogicalOperator::AND, $cityCondition, $countryCondition);
    ...
    public function test_sqlite_to_eloquent_subcondition_with_or(): void
    {
        $condition1 = new ConditionNode('city', ComparisonOperator::EQUAL, 'Kinshasa');
        $condition2 = new ConditionNode('city', ComparisonOperator::EQUAL, 'Paris');
        $orNode = new GroupNode(LogicalOperator::OR, $condition1, $condition2);
    ...
    public function test_sqlite_to_eloquent_subcondition_with_like(): void
    {
        $condition = new ConditionNode('city', ComparisonOperator::LIKE, 'Kin%');
        $node = new SubConditionNode('addresses', $condition);
    ...
    public function test_sqlite_to_eloquent_subcondition_with_nested_path(): void
    {
        $condition = new ConditionNode('email', ComparisonOperator::EQUAL, 'yes');
        $node = new SubConditionNode('settings.notifications', $condition);
    ...
    public function test_sqlite_to_eloquent_subcondition_with_exists(): void
    {
        $condition = new ConditionNode('city', ComparisonOperator::EXISTS);
        $node = new SubConditionNode('addresses', $condition);
    ...
    public function test_sqlite_to_eloquent_subcondition_with_not_exists(): void
    {
        $condition = new ConditionNode('city', ComparisonOperator::NOT_EXISTS);
        $node = new SubConditionNode('addresses', $condition);
    ...
    public function test_sqlite_full_query_with_subcondition_and_status(): void
    {
    ...
    public function test_sqlite_full_query_with_subcondition_or_status(): void
    {
        $statusNode = new ConditionNode('status', ComparisonOperator::EQUAL, 'active');
    ...
    public function test_sqlite_full_query_with_complex_subcondition(): void
    {
    ...
    public function test_sqlite_to_eloquent_subcondition_combined_with_condition(): void
    {
    ...
    public function test_sqlite_get_children_with_group(): void
    {
        $cityCondition = new ConditionNode('city', ComparisonOperator::EQUAL, 'kinshasa');
        $countryCondition = new ConditionNode('country', ComparisonOperator::EQUAL, 'rdc');
        $andNode = new GroupNode(LogicalOperator::AND, $cityCondition, $countryCondition);
